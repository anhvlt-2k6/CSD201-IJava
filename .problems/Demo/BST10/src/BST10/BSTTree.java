...
public class BSTTree {
    ...
    String resultPreOrderParent = ""; // Self-writing
...
//                    temp = current.left.findMaxNode();
    ...
    void preOderParent(BSTNode currentNode) {
        ...
        for (int i = 0; i < currentNode.count; i++) {
            System.out.println(currentNode.data);
            String parentNode = (currentNode.isRoot()) ? ("null") : (String.valueOf(currentNode.parent.data));
            resultPreOrderParent += "," + currentNode.data + "[" + parentNode + "]";
        }
        
        preOderParent(currentNode.left);
        preOderParent(currentNode.right);
    }
...
//            out.write(resultInOder.substring(1) + "\n");
...
//            out.write(resultFindNode.substring(2) + "\r\n"); 
            out.write(resultPreOrderParent.substring(1) + "\r\n");
