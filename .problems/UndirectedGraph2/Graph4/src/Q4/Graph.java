...
//            out.write(resultDijkstra.substring(1));
            ...
            if (resultspDijkstra.trim().equals(String.format("%d", Integer.MAX_VALUE))
                    || resultspDijkstra.trim().equals(String.format("%d", Integer.MAX_VALUE))) {
                out.write("No path");
            } else {
                out.write(resultspDijkstra);
                out.write(resultbacktrackDijkstra.substring(1).replace(" ", "->"));
            }
