...
//                    temp = current.left.findMaxNode();
    ...
    void preOder(BSTNode currentNode) {
        ...
        for (int i = 0; i < currentNode.count; i++) {
            System.out.println(currentNode.data);
            if (currentNode.data >= snode) resultPreOder += "," + currentNode.data;
        }
    ...
    void postOrder(BSTNode currentNode) {
        ...
        for (int i = 0; i < currentNode.count; i++) {
            System.out.println(currentNode.data);
            if (currentNode.data >= snode) resultPostOrder += "," + currentNode.data;
        }
    }
    ...
    void inOrder(BSTNode currentNode) {
        ...
        for (int i = 0; i < currentNode.count; i++) {
            System.out.println(currentNode.data);
            if (currentNode.data >= snode) resultInOder += "," + currentNode.data;
        }
