...
//                    temp = current.left.findMaxNode();
    ...
    void findParent(BSTNode currentNode) {
        if (currentNode == null) {
            return;
        }
        ...
        for (int i = 0; i < currentNode.count; i++) {
            ...
            if (currentNode.parent != null) {
                resultParent += "," + currentNode.data + "[" + currentNode.parent.data + "]";
            } else {
                resultParent += "," + currentNode.data + "[null]";
            }
        }
        
        findParent(currentNode.left);
        findParent(currentNode.right);
    }
...
//            out.write(resultPreOderLevel.substring(1) + "\r\n"); 
            out.write(resultParent.substring(1) + "\r\n"); 
